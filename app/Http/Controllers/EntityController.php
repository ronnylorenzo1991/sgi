...
use App\Models\Entities\Repository\EntityRepository;
...
class EntityController extends Controller
{
    ...
    {
        $entities = Entity::latest('id')->paginate(10);
    ...
    public function getAll(Request $request)
    {
        ...
        $entities = $this->entityRepository->getAll($sortBy, $sortDir, $perPage, $page);
